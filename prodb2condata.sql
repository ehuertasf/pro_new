...
CREATE TABLE `tb_chkfamiliar` (
  ...
  `codpar` int(5) unsigned NOT NULL,
  ...
  KEY `fk_tb_chkfamiliar_tb_parentesco1` (`codpar`),
  CONSTRAINT `fk_tb_chkfamiliar_tb_parentesco1` FOREIGN KEY (`codpar`) REFERENCES `tb_parentesco` (`codpar`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=latin1 PACK_KEYS=0;
...
CREATE TABLE `tb_imgdomicilio` (
  ...
  `nomimgdom` varchar(50) default 'default.jpg',
...
CREATE TABLE `tmp_estactchk` (
  ...
  `codchkreg` int(10) NOT NULL,
  PRIMARY KEY  (`codsol`,`codper`,`loguser`,`codchkreg`)
...
CREATE TABLE `tmp_estperchk` (
  ...
  `loguser` varchar(20) NOT NULL,
  `codchkreg` int(10) NOT NULL,
  PRIMARY KEY  (`codsol`,`codper`,`codchk`,`codestchk`,`loguser`,`codchkreg`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
