...
function mttousers(){
    ...
    dsusers = new Ext.data.Store({
        reader : new Ext.data.JsonReader({
                fields : ['coduser', 'nomuser','apeuser','loguser','pasuser','estuser','est'],
                root : 'users',
                id : 'coduser'
        }),
        proxy: new Ext.data.HttpProxy({
					...
					if(btn=='yes'){
						...
						frm_user.form.submit({
							...
							failure:function(form,action){
								Ext.Msg.alert('Cuidado','Ocurrio un error comuniquese con el administrador')
							}
